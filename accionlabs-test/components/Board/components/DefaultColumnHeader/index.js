...
export default function ({ children: column, allowRemoveColumn, onColumnRemove, allowRenameColumn, onColumnRename }) {
  ...
  return (
    <div className='react-accion-test-column-header'>
      {renameMode ? (
        <form onSubmit={handleRenameColumn}>
          ...
          <span>
            <button className='react-accion-test-column-header__button' type='submit'>
              Rename
            </button>
            <button className='react-accion-test-column-header__button' type='button' onClick={handleRenameMode}>
              Cancel
            </button>
          </span>
        </form>
